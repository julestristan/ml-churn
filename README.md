# Telco Customer Churn: Machine learning model for Build & Deployment

## 1 - Setting up the project

### a - Cloning the repository

Clone the repo from the github link:
...
### c - Setting up the libraries

Inside the root folder of the project, type in the terminal:

```bash
uv venv
```

In the root folder of the project, execute the following command:

```bash
uv pip install -r requirements.txt
```

The project is now correctly installed :grin:
